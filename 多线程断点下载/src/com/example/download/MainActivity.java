...
import com.example.network.DownloadProgressListener;
		...
		public void handleMessage(Message msg) {
			...
			case 1:
				...
				if (progressBar.getProgress() == progressBar.getMax()) {
					...
					Toast.makeText(MainActivity.this, R.string.success, 1)
							.show();
	...
	private void download(final String path, final File savedir) {
		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				FileDownloader loader = new FileDownloader(MainActivity.this,
						path, savedir, 3);
